...
export const requestFriend = createAsyncThunk('friendships/requestFriend',async(targetUserId)=>{
    try{
...
export const acceptFriend = createAsyncThunk('friendships/acceptFriend',async(targetUserId)=>{
    try{
...
export const rejectFriend = createAsyncThunk('friendships/rejectFriend',async(targetUserId)=>{
    try{
...
export const cancelRequest = createAsyncThunk('friendships/cancelRequest',async(targetUserId)=>{
    try{
