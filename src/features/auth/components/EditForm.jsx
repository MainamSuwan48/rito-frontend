...
export function EditForm({user}) {
  ...
  return (
    <Dialog>
      <DialogTrigger 
        asChild
        className='h-fit text-center text-base font-semibold  text-white gap-2.5 bg-pink-500 px-20 py-4 rounded-none'
      >
      ...
      <DialogContent className="sm:max-w-[525px]">
        ...
        >
            <div className='inline-flex flex-col items-start justify-start mt-4 gap-6 w-[550px]'>
                <div className='relative w-full'>
                    <div className='flex-shrink-0 mb-2 font-semibold text-base_dark'>Display Name :</div>
                    <input
                      type='text'
                ...
                <div className='relative w-full'>
                    <div className=' flex-shrink-0 mb-2 font-semibold text-base_dark'>Description :</div>
                    <input
                      type='text'
                ...
                <div className='relative w-full'>
                    <div className='flex-shrink-0 mb-2 w-[100px] font-semibold text-base_dark'>Firstname :</div>
                    <input
                      type='text'
                      {...register('firstName')}
                      className='input-bordered rounded-md w-full border-2 p-1.5 text-black'
                ...
                <DialogFooter className="flex justify-end w-full ">
                    <Button className="bg-pink-500" type="submit">Save changes</Button>
                </DialogFooter>
